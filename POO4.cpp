...
//structura care defineste un pacient care sa aibe minim 3 atribute minim 3 tipuri de date si alocare dinamica pentru 
...
int main()
{
	...
	p.id = 12;
	strcpy_s(s.nume, "Calin");
	strcpy_s(s.prenume, "Popescu");
	p.boala = new int(7);
	p.tensiune = 3.2;
